...
export default function LeaderboardPage() {
  ...
  return pageWrapper(
    <main className="flex-1 flex flex-col items-center justify-center px-6 py-6 gap-6 mx-auto w-full relative z-10">
      {/* Title row */}
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.96 }}
        className="relative flex items-center justify-center w-52 h-14 px-14 py-4 font-mono text-xl uppercase tracking-[0.2em]
